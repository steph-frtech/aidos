// Command mirror-library is the AIDOS Mirror project-library MCP server (S70; ADR 0009: every backend
// op is an MCP tool).
//
...
// no I/O, never an LLM. The detector REUSES records.ComputeCompleteness verbatim. Transport: stdio.
package main
