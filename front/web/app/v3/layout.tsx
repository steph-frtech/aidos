...
const KEYS = [
	...
	"emetteursDesktopTitle",
	"emetteursDesktopIntro",
	"emetteursDesktopChildren",
	"emetteursDesktopChildrenError",
	"emetteursDesktopLoading",
	"emetteursDesktopMaster",
	"emetteursDesktopArtifacts",
	"emetteursDesktopCapture",
	"emetteursDesktopCapturing",
	"emetteursDesktopFrameAlt",
	...
	"liensWallNote",
	"liensSourceLive",
	"liensSourceLiveTitle",
	"liensSourceDemo",
	"liensSourceDemoTitle",
	"liensKernels",
	"liensLinks",
	"liensFilterLabel",
	"liensAll",
	"liensKind_projects_to",
	"liensKind_derives_from",
	"liensKind_contracts_with",
	"liensKind_triggers",
	"liensKind_binds",
	"liensKind_mirrors",
	"liensStatus_green",
	...
	"evolveTitle",
	"evolveIntro",
	"evolveSamplerHeading",
	"evolveSamplerHint",
	"evolveSamplerSelfPlay",
	"evolveSamplerDet",
	"evolveRunBtn",
	"evolveRunHint",
	"evolveCoverageHeading",
	"evolveCoverageLabel",
	"evolveCoverageNone",
	"evolveVariantsHeading",
	"evolveVariantsHint",
	"evolveColNiche",
	"evolveColMutation",
	"evolveColMirror",
	...
	"evolveColAuthority",
	"evolveColVerdict",
	"evolveVerdictProposed",
	"evolveVerdictRefused",
	"evolveRefusalMirror",
	"evolveRefusalOos",
	"evolveRefusalAuthority",
	"evolveGreen",
	"evolveRed",
	"evolveApproved",
	"evolveNotApproved",
	...
	"benchKind_view_goal",
	"benchKind_view_zone",
	"benchKind_view_displayed",
	"benchKind_view_empty_state",
	"benchKind_control_exists",
	"benchKind_control_visible_when",
	"benchKind_control_enabled_when",
	"benchKind_control_triggers",
	"benchKind_action_invoke",
	"benchKind_action_on_success",
	"benchKind_action_on_error",
	"benchKind_operation_exists",
	"benchKind_operation_event",
	"benchKind_operation_guard",
	"benchKind_entity_exists",
	"benchKind_entity_field",
	"benchKind_entity_relation",
	"benchKind_invariant_forall",
	"benchKind_policy_authz",
	"benchKind_budget_perf_sec",
	"benchKind_case_error",
	"benchKind_case_edge",
] as const;
