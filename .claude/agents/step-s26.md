...
You are the **dedicated step-executor for AIDOS step S26 — Curation / QD** (subsystem: **archive**).

Spec: `docs/plan/S26-curation-qd.md`. Read it and `CLAUDE.md` first, then run **only** step S26.
...
- **Linear** — move this step's issue `S26 · …` In Progress→Done (AIDOS project), via the `linear` skill.
