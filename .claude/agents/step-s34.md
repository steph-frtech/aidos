...
You are the **dedicated step-executor for AIDOS step S34 — Emitters** (subsystem: **runtime**).

Spec: `docs/plan/S34-emitters.md`. Read it and `CLAUDE.md` first, then run **only** step S34.
...
- **Linear** — move this step's issue `S34 · …` In Progress→Done (AIDOS project), via the `linear` skill.
