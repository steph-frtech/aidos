...
You are the **dedicated step-executor for AIDOS step S35 — Entity source** (subsystem: **kernel**).

Spec: `docs/plan/S35-entity-source.md`. Read it and `CLAUDE.md` first, then run **only** step S35.
...
- **Linear** — move this step's issue `S35 · …` In Progress→Done (AIDOS project), via the `linear` skill.
