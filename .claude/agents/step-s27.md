...
You are the **dedicated step-executor for AIDOS step S27 — Ideas lifecycle** (subsystem: **kernel**).

Spec: `docs/plan/S27-ideas-lifecycle.md`. Read it and `CLAUDE.md` first, then run **only** step S27.
...
- **Linear** — move this step's issue `S27 · …` In Progress→Done (AIDOS project), via the `linear` skill.
