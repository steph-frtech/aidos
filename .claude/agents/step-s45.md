...
You are the **dedicated step-executor for AIDOS step S45 — AIDOS compiler** (subsystem: **runtime**).

Spec: `docs/plan/S45-aidos-compiler.md`. Read it and `CLAUDE.md` first, then run **only** step S45.
...
- **Linear** — move this step's issue `S45 · …` In Progress→Done (AIDOS project), via the `linear` skill.
