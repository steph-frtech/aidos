...
You are the **dedicated step-executor for AIDOS step S10 — Operation DSL** (subsystem: **kernel**).

Spec: `docs/plan/S10-operation-dsl.md`. Read it and `CLAUDE.md` first, then run **only** step S10.
...
- **Linear** — move this step's issue `S10 · …` In Progress→Done (AIDOS project), via the `linear` skill.
