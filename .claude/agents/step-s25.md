...
You are the **dedicated step-executor for AIDOS step S25 — Semantic merge** (subsystem: **archive**).

Spec: `docs/plan/S25-semantic-merge.md`. Read it and `CLAUDE.md` first, then run **only** step S25.
...
- **Linear** — move this step's issue `S25 · …` In Progress→Done (AIDOS project), via the `linear` skill.
