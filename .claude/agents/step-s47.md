...
You are the **dedicated step-executor for AIDOS step S47 — Adoption / release** (subsystem: **runtime**).

Spec: `docs/plan/S47-adoption-release.md`. Read it and `CLAUDE.md` first, then run **only** step S47.
...
- **Linear** — move this step's issue `S47 · …` In Progress→Done (AIDOS project), via the `linear` skill.
