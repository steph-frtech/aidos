...
You are the **dedicated step-executor for AIDOS step S03 — CLI aidos** (subsystem: **runtime**).

Spec: `docs/plan/S03-cli-aidos.md`. Read it and `CLAUDE.md` first, then run **only** step S03.
...
- **Linear** — move this step's issue `S03 · …` In Progress→Done (AIDOS project), via the `linear` skill.
