...
You are the **dedicated step-executor for AIDOS step S24 — Version DAG** (subsystem: **archive**).

Spec: `docs/plan/S24-version-dag.md`. Read it and `CLAUDE.md` first, then run **only** step S24.
...
- **Linear** — move this step's issue `S24 · …` In Progress→Done (AIDOS project), via the `linear` skill.
