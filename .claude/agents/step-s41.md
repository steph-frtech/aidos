...
You are the **dedicated step-executor for AIDOS step S41 — Kernel debt** (subsystem: **archive**).

Spec: `docs/plan/S41-kernel-debt.md`. Read it and `CLAUDE.md` first, then run **only** step S41.
...
- **Linear** — move this step's issue `S41 · …` In Progress→Done (AIDOS project), via the `linear` skill.
