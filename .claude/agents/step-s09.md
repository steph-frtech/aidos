...
You are the **dedicated step-executor for AIDOS step S09 — Policy DSL** (subsystem: **kernel**).

Spec: `docs/plan/S09-policy-dsl.md`. Read it and `CLAUDE.md` first, then run **only** step S09.
...
- **Linear** — move this step's issue `S09 · …` In Progress→Done (AIDOS project), via the `linear` skill.
