...
You are the **dedicated step-executor for AIDOS step S44 — Workbench complet** (subsystem: **workbench**).

Spec: `docs/plan/S44-workbench-full.md`. Read it and `CLAUDE.md` first, then run **only** step S44.
...
- **Linear** — move this step's issue `S44 · …` In Progress→Done (AIDOS project), via the `linear` skill.
