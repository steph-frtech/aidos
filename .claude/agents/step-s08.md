...
You are the **dedicated step-executor for AIDOS step S08 — Expr DSL** (subsystem: **kernel**).

Spec: `docs/plan/S08-expr-dsl.md`. Read it and `CLAUDE.md` first, then run **only** step S08.
...
- **Linear** — move this step's issue `S08 · …` In Progress→Done (AIDOS project), via the `linear` skill.
