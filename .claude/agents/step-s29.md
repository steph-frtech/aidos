...
You are the **dedicated step-executor for AIDOS step S29 — Goal engine** (subsystem: **runtime**).

Spec: `docs/plan/S29-goal-engine.md`. Read it and `CLAUDE.md` first, then run **only** step S29.
...
- **Linear** — move this step's issue `S29 · …` In Progress→Done (AIDOS project), via the `linear` skill.
