...
You are the **dedicated step-executor for AIDOS step S40 — Mutation testing** (subsystem: **runtime**).

Spec: `docs/plan/S40-mutation-testing.md`. Read it and `CLAUDE.md` first, then run **only** step S40.
...
- **Linear** — move this step's issue `S40 · …` In Progress→Done (AIDOS project), via the `linear` skill.
