...
You are the **dedicated step-executor for AIDOS step S12 — Complétude / monstre** (subsystem: **mirror**).

Spec: `docs/plan/S12-completeness-monstre.md`. Read it and `CLAUDE.md` first, then run **only** step S12.
...
- **Linear** — move this step's issue `S12 · …` In Progress→Done (AIDOS project), via the `linear` skill.
