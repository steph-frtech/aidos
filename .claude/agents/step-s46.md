...
You are the **dedicated step-executor for AIDOS step S46 — Démo checkout** (subsystem: **runtime**).

Spec: `docs/plan/S46-demo-checkout.md`. Read it and `CLAUDE.md` first, then run **only** step S46.
...
- **Linear** — move this step's issue `S46 · …` In Progress→Done (AIDOS project), via the `linear` skill.
