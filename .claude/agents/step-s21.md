...
You are the **dedicated step-executor for AIDOS step S21 — SemanticDiff** (subsystem: **archive**).

Spec: `docs/plan/S21-semantic-diff.md`. Read it and `CLAUDE.md` first, then run **only** step S21.
...
- **Linear** — move this step's issue `S21 · …` In Progress→Done (AIDOS project), via the `linear` skill.
