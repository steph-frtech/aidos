...
You are the **dedicated step-executor for AIDOS step S02 — KRDCore — records** (subsystem: **kernel**).

Spec: `docs/plan/S02-krdcore-records.md`. Read it and `CLAUDE.md` first, then run **only** step S02.
...
- **Linear** — move this step's issue `S02 · …` In Progress→Done (AIDOS project), via the `linear` skill.
